...
Des petites pages pour voir ce qu'on peut faire avec HTML, CSS et JavaScript. Ouvre chaque `index.html` dans ton navigateur (double-clic, ou clic droit puis « ouvrir avec »).

- `0-bases-js/` : une page qui montre les notions de base de JavaScript (const, let, console.log, nombres, chaînes, booléens, if, for, le DOM) avec, à chaque fois, le code et son résultat.
